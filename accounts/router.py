...
FULL_NAME = 0
CHOOSE_SPECIE_REPLY_MARKUP = ReplyKeyboardMarkup.from_button(KeyboardButton("Выбрать расу"), resize_keyboard=True)


async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Афиша мероприятия", reply_markup=CHOOSE_SPECIE_REPLY_MARKUP)
